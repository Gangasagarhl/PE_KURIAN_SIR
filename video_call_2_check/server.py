...
async def offer(request):
    try:
        ...
        # Open the local video device.
        try:
            # Adjust the device string and format as needed.
            # For Linux use: "/dev/video0" with format="v4l2"
        ...
        # Add available media tracks from the server’s device.
        if player.video:
