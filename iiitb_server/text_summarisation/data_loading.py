...
"""
The timingly based data is stored in the csv database.
The reason why I have not stored the data in the databse, because inserting and extracting the data to database is costly. 
The summary will be stored into the database, daily 2 times the summary will be stored. 
This summary will be later used for RAG application. 
This is used for getting the data from the database in csv format.
